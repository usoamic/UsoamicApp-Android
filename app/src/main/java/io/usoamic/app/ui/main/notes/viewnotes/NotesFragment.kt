...
import io.usoamic.app.custom.InputDialogBuilder
...
import io.usoamic.app.extensions.navigate
...
import io.usoamic.app.ui.main.notes.viewnotes.adapter.NotesAdapter
...
class NotesFragment : BaseSrViewModelFragment(R.layout.fragment_notes) {
    ...
    override fun inject() {
        UsoamicApp.component.notesSubcomponent.create().inject(this)
    }
